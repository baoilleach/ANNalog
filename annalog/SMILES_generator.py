...
class SMILESGenerator:
    ...
    def generate_smiles(self, input_smiles, generation_number=100, generation_method='C-beam',
                        temperature=1.2, prefix=0, filter_invalid=False, seed=42):
        """
        ...
        Args:
            ...
            seed (int): Random seed (used only for sampling decoder).
